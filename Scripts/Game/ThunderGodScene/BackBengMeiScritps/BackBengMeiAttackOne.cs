...
public class BackBengMeiAttackOne : ActionState
{
    ...
    Vector2 joyPos;
    public BackBengMeiAttackOne(EActionType type, ActionMachine am, GameObject master, ActionState pnt = null, ActionState cld = null)
    ...
    override public void Update()
    {
        ...
        if (Application.platform != RuntimePlatform.Android)
        {
            ...
            if (isFollowUpAttackOpen == true)
            {
                if (Input.GetMouseButtonDown(0))
                {
                    mAm.ChangeAction(EActionType.AttackTwo);
                    return;
                }
    ...
    override public void OnAnimationHit(int i)
    {
        ...
        TimerMgr.Instance.OneShot("BackBengMeiAttackOneWeaPonRightHandUnActive", 0.35f, BackBengMeiAttackOneWeaPonRightHandUnActive);
    }
    void BackBengMeiAttackOneWeaPonRightHandUnActive()
    {
