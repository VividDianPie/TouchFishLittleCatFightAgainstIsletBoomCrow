...
public class BackBengMeiAttackThree : ActionState
{
    private bool whetherTheCombo;
    private bool isFollowUpAttackOpen;
    private bool currentAnimationAbleMove;
    Vector2 joyPos;
    public BackBengMeiAttackThree(EActionType type, ActionMachine am, GameObject master, ActionState pnt = null, ActionState cld = null)
    ...
    override public void Update()
    {
        ...
        if (Application.platform != RuntimePlatform.Android)
        {
            ...
            if (isFollowUpAttackOpen == true)
            {
                if (Input.GetMouseButtonDown(0))
                {
                    mAm.ChangeAction(EActionType.AttackFour);
                    return;
                }
    ...
    override public void OnAnimationHit(int i)
    {
        ...
        TimerMgr.Instance.OneShot("BackBengMeiAttackThreeWeaPonRightHandUnActive", 0.2f, BackBengMeiAttackThreeWeaPonRightHandUnActive);
    }
    void BackBengMeiAttackThreeWeaPonRightHandUnActive()
    {
