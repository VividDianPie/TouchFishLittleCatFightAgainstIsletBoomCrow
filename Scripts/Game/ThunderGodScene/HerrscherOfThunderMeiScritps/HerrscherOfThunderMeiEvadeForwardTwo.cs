...
public class HerrscherOfThunderMeiEvadeForwardTwo : ActionState
{
    public HerrscherOfThunderMeiEvadeForwardTwo(EActionType type, ActionMachine am, GameObject master, ActionState pnt = null, ActionState cld = null)
